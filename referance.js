...
!(function (a) {
  ...
  (function (window, $, Backbone) {
    ...
    var ShareBox = SingleView.extend({
      ...
      initialize: function () {
        ...
        html +=
          ' <a title="Facebook" class="ui-icon show-hint"  target="_blank" rel="noopener"><i class="fab fa-facebook-square mx-2 socicon"></i></a>';
        
        html +=
          ' <a title="Linkedin" class="ui-icon show-hint" href="https://www.linkedin.com/company/reairuae" target="_blank" rel="noopener"><i class="fab fa-linkedin mx-2 socicon"></i></a> |';
  ...
  FlipbookSettings = {
    ...
    shareMessage: "REair Brochure",
    pageFolder: "../assets/images/brochure/en",
    loadRegions: true
  };
